...
import {Platform, StyleSheet, Text, View, Image, SectionList, TouchableHighlight, Alert} from 'react-native';
// Redux
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.content}>
          ...
          <TouchableHighlight style={styles.button} underlayColor={"rgba(244,244,244,1)"} onPress={this.care}>
            <View>
